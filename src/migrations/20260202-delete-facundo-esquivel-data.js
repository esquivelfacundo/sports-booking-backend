...
module.exports = {
  up: async (queryInterface) => {
    ...
    await queryInterface.sequelize.query(`DELETE FROM recurring_booking_instances WHERE "recurringBookingId" IN (SELECT id FROM recurring_bookings WHERE "clientId" = '${clientId}')`);
    await queryInterface.sequelize.query(`DELETE FROM recurring_bookings WHERE "clientId" = '${clientId}'`);
